#include "LShape.h"
void LShape::CreateOBBBox(float fExtentX, float fExtentY, float fExtentZ,
	TVector3 vCenter,
	TVector3 vDirX,
	TVector3 vDirY,
	TVector3 vDirZ)
...
void LShape::CreateAABBBox(TVector3 max, TVector3 min)
{
	m_Box.vMax = max;
	m_Box.vMin = min;
...
//                            TLineShape
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
HRESULT LLineShape::SetInputLayout()
{
	HRESULT hr = S_OK;
...
bool LLineShape::CreateVertexData()
{
...
bool LLineShape::CreateIndexData()
{
...
HRESULT LLineShape::CreateVertexBuffer()
{
...
bool LLineShape::Draw(ID3D11DeviceContext* pContext, TVector3 vStart, TVector3 vEnd, TVector4 vColor)
{
...
// 
//--------------------------------------------------------------------------------------
HRESULT LLineShape::CreateResource()
{
	m_dxobj.m_iPrimitiveType = D3D10_PRIMITIVE_TOPOLOGY_LINELIST;
	return S_OK;
}
LLineShape::LLineShape(void)
{
}
...
//                            TLineShape
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
HRESULT LDirectionLineShape::SetInputLayout()
{
	HRESULT hr = S_OK;
...
bool LDirectionLineShape::CreateVertexData()
{
...
bool LDirectionLineShape::CreateIndexData()
{
...
HRESULT LDirectionLineShape::CreateVertexBuffer()
{
	if (m_dxobj.m_iNumVertex <= 0) return S_OK;
	m_dxobj.g_pVertexBuffer.Attach(DX::CreateVertexBuffer(m_pd3dDevice,
		&m_LineVertexList.at(0),
...
// 
//--------------------------------------------------------------------------------------
HRESULT LDirectionLineShape::CreateResource()
{
	m_dxobj.m_iPrimitiveType = D3D11_PRIMITIVE_TOPOLOGY_LINELIST;
	return S_OK;
}
LDirectionLineShape::LDirectionLineShape(void)
{
}
...
bool LBoxShape::CreateVertexData()
{
	// 상단
	// 5    6
	// 1    2
...
bool LBoxShape::CreateIndexData()
{
...
// 
//--------------------------------------------------------------------------------------
HRESULT LPlaneShape::CreateResource()
{
	m_dxobj.m_iPrimitiveType = D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST;
	return S_OK;
}
...
bool LSphereShape::CreateVertexData()
{
	CreateSphere(40);
...
bool LSphereShape::CreateIndexData()
{
	return true;
}

void LSphereShape::MakeSpherePoint(std::vector<TVector3>& spherePoints,
	UINT Slices,
...
void LSphereShape::CreateSphere(UINT Slices, float fRadius)
{
...
bool LSphereShape::Render(ID3D11DeviceContext* pContext)
{
	PreRender(pContext);
...
// 
//--------------------------------------------------------------------------------------
HRESULT LSphereShape::CreateResource()
{
	m_dxobj.m_iPrimitiveType = D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST;
	return S_OK;
}
LSphereShape::LSphereShape(void)
{
}
