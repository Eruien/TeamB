...
void InGameScene::Process()
{
    ...
    FrameBullet();
    CalcPhysics(); // calc height and collision
...
void InGameScene::LoadMapAndSky()
{
    // 맵 오브젝트 예시
...
void InGameScene::LoadTreeAndBullet()
{
...
void InGameScene::LoadLightAndShadow()
{
...
void InGameScene::FrameMap()
{
}

void InGameScene::FramePlayerAndZombie()
{
...
void InGameScene::CalcPhysics()
{
    // calc Player's Height
...
void InGameScene::FrameMuzzleFlash()
{
    //포워드 구하는법좀..
...
void InGameScene::LoadMuzzleFlash()
{
    //muzzleflash
