...
bool InGameScene::Init()
{
    ...
    // viewPort
    ZeroMemory(&_minimapVP, sizeof(_minimapVP));

    _minimapVP.Width = 300.0f;
    _minimapVP.Height = 300.0f;
    _minimapVP.MinDepth = 0.0f;
    _minimapVP.MaxDepth = 1.0f;
    _minimapVP.TopLeftX = 0.0f;
    _minimapVP.TopLeftY = 0.0f;

   // LGlobal::g_pImmediateContext->RSSetViewports(1, &_minimapVP);
